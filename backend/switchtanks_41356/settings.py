"""
Django settings for switchtanks_41356 project.
...
ROOT_URLCONF = 'switchtanks_41356.urls'
...
WSGI_APPLICATION = 'switchtanks_41356.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "switchtanks_41356 API",
    "DESCRIPTION": "API documentation for switchtanks_41356 App",
    "VERSION": "v1",
}
